namespace UglyToad.PdfPig
{
    ...
    public abstract class BaseDrawingProcessor : IOperationContext, IDrawingProcessor
    {
        ...
        private InternalParsingOptions internalParsingOptions;
        ...
        public void ShowText(IInputBytes bytes)
        {
            ...
            while (bytes.MoveNext())
            {
                ...
                var color = currentState.FontState.TextRenderingMode != TextRenderingMode.Stroke
                    ? new AlphaColor(currentState.AlphaConstantNonStroking, currentState.CurrentNonStrokingColor ?? GrayColor.Black)
                    : new AlphaColor(currentState.AlphaConstantStroking, currentState.CurrentStrokingColor ?? GrayColor.Black);
        ...
        private void ProcessFormXObject(StreamToken formStream)
        {
            ...
            if (hasResources)
            {
                resourceStore.LoadResourceDictionary(formResources, internalParsingOptions);
            }
        ...
        public void Init(Page page)
        {
            ...
            internalParsingOptions = new InternalParsingOptions(
                new List<string>(), false, true, true, this.log); // todo
